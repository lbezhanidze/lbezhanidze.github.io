...
function kura_tm_cursor(){
	...
	if(myCursor.length){
        ...
        }, $("body").on("mouseenter", "a,span,.kura_tm_topbar .trigger, .cursor-pointer", function () {
            e.classList.add("cursor-hover"), t.classList.add("cursor-hover")
        }), $("body").on("mouseleave", "a,span,.kura_tm_topbar .trigger, .cursor-pointer", function () {
            ($(this).is("a") || $(this).is("span")) && $(this).closest(".cursor-pointer").length || (e.classList.remove("cursor-hover"), t.classList.remove("cursor-hover"))
